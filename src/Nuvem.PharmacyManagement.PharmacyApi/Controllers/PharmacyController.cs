...
public class PharmacyController : ControllerBase
{
    ...
    public async Task<ActionResult> GetPharmacistListByPharmacyId(int id, [FromBody] ParameterCollection pageParams)
    {
        ...
        var PharmacistList = _pharmacyService.GetPharmacistListByPharmacyIdAsync(id, pageParams);
    ...
    {
        PharmacyDisplayResult<Pharmacy>? result = _pharmacyService.PaginatedPharmacyListAsync(pageParams);
    ...
    public async Task<ActionResult> UpdatePharmacyById([FromBody] Pharmacy pharmacy)
    {
        ...
        else if (pharmacy.PharmacyId >= 1)
        {
            var updatedPharmacy = _pharmacyService.UpdatePharmacyAsync(pharmacy);
